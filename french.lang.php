...
$lang_admin['toolboxonlinenote']= 'When clicking &quot;Test&quot; or &quot;Release&quot;, the configuration of this release will be transmitted to B1G Software in order to create the release files. Creating the test or release versions may take a few minutes.';
...
$lang_admin['bmtoolbox']		= 'YoopyaMail Toolbox';
...
$lang_admin['selffolder']		= 'Abs. path to YoopyaMail';
...
$lang_admin['copyrightnote']	= 'Copyright note';
$lang_admin['c_err_1']			= 'This YoopyaMail license is a license with copyright note, but the copyright note is not present in your current template or has been modified. Please respect our terms of license and buy a valid license without copyright note, when you want to remove or modify the note.';
$lang_admin['c_err_2']			= 'The following code must be present in the template files <code>li/index.tpl</code> and <code>nli/index.tpl</code>:';
$lang_admin['c_err_3']			= 'If you already own a license without copyright note, you did not install the license upgrade correctly. <a href="http://www.b1g.de/support/kb/questions.php?questionid=46" target="_blank">Click here</a> to view instructions how to install the upgrade correctly.';
...
$lang_admin['about']			= 'About YoopyaMail';
$lang_admin['version']			= 'Version';
$lang_admin['nonotices']		= 'Currently there are no new notifications.';
$lang_admin['save']				= 'Save';
$lang_admin['licensedto']		= 'Licensed to';
$lang_admin['licenseno']		= 'License number';
$lang_admin['serial']			= 'Serial number';
...
$lang_admin['debugmode']		= 'YoopyaMail is currently in debug mode. You should disable the debug mode when being in production use.';
...
$lang_admin['dataperms']		= 'Cannot write to the YoopyaMail data directory (<code>%s</code>). Please check the access rights!';
$lang_admin['invaliddata']		= 'The YoopyaMail data directory (<code>%s</code>) could not be found. Please check the path and try again!';
...
$lang_admin['tempdesc']			= 'Temporary files will usually be deleted by YoopyaMail if they are no longer required. You may also start the cleanup process manually. Please note that only those files will be deleted that have reached a certain age.';
...
$lang_admin['gdlib']			= 'The <code>gd</code> PHP extension is not available. Some of the graphics-related features of YoopyaMail require this extension. If possible, you should install it.';
...
$lang_admin['ce_b1gmail']		= 'YoopyaMail cache manager';
$lang_admin['ce_b1gmail_desc']	= 'Will use the YoopyaMail cache manager to cache objects (recommended if memcached is not available).';
...
$lang_admin['filecachedesc']	= 'If file cache is enabled, YoopyaMail itself will administrate the caching of objects that are CPU-intensive to generate. The cache will usually be administrated automatically and will also be cleaned up automatically if required. Here you can empty the cache manually if required.';
...
$lang_admin['addlang_desc']		= 'Here you can install a new language file (.lang.php file) by uploading it using the following form. Please make sure the language file is applicable for your version of YoopyaMail.';
...
$lang_admin['selfurl']			= 'YoopyaMail URL';
$lang_admin['mobile_url']		= 'Mobile YoopyaMail URL';
$lang_admin['ssl']				= 'SSL';
$lang_admin['ssl_url']			= 'YoopyaMail SSL URL';
...
$lang_admin['maintmodenote']	= 'Maintenance mode is enabled. The YoopyaMail installation is not accessible for users.';
...
$lang_admin['searchprovider']	= 'YoopyaMail search provider';
...
$lang_admin['autoperms_desc']	= 'If you give the FTP-details from your YoopyaMail installation here, the update wizard will be able to give permission for files to be updated automatically. That will make the updating process a lot easier for you. You will not need an FTP client or the like.';
$lang_admin['ftphost']			= 'FTP host';
$lang_admin['ftpport']			= 'FTP port';
$lang_admin['ftpuser']			= 'FTP user';
$lang_admin['ftppass']			= 'FTP password';
$lang_admin['ftpdir']			= 'Directory to YoopyaMail';
$lang_admin['ftpperms']			= 'Default permissions';
$lang_admin['patchlevel']		= 'Patch level';
$lang_admin['patchlevel_desc']	= 'In the following you will find the current patch level of your YoopyaMail installation. In a small number of situations it may be useful to reset the patch level number. After that, all updates can be installed again.';
...
$lang_admin['updatesdesc']		= 'Please click the following button to search for updates (e.g. important security updates) for your YoopyaMail installation. Please note that in the updating process the license number and serial number of your YoopyaMail license will be transmitted to our update server.';
$lang_admin['upderrordesc']		= 'An error occurred while trying to update. Please read the following error message.';
$lang_admin['noupdatesfound']	= 'No updates for your YoopyaMail installation have been found. Please try again later if necessary.';
$lang_admin['updatesfound']		= 'The following updates for your YoopyaMail installation have been found.';
...
$lang_admin['forb1gmail']		= 'For YoopyaMail';
...
$lang_admin['sigofficial_desc']	= 'This plugin package was officially released by Yoopya Software and has a valid signature. It may be installed without concern.';
...
$lang_admin['openssl_err']		= 'The PHP extension <code>openssl</code> is not available. S/MIME support required the PHP <code>openssl</code> extension to be installed. Please install the extension in order to use S/MIME in YoopyaMail.';
